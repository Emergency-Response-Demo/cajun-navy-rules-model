...
public class Incident implements Serializable {
    ...
    @PlanningVariable( valueRangeProviderRefs = { "responders" } )
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ( ( assignedResponder == null ) ? 0 : assignedResponder.hashCode() );
    ...
    public boolean equals( Object obj ) {
        ...
        if ( assignedResponder == null ) {
            if ( other.assignedResponder != null )
                return false;
        } else if ( !assignedResponder.equals( other.assignedResponder ) )
            return false;
        if ( id == null ) {
            if ( other.id != null )
                return false;
